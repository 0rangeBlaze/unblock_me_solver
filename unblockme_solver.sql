...
*/
   ...
   */
		dbms_output.put_line('boardfromblocks iterations = ' ||  tmp);
     printstep(id);
    else
...
--  v_str := 'ABCCDDABE000XXE00KFFEJ0KGHHJ0KGIII00'; -- expert challenge 398
  v_str := '0ABBCC0A0DI0XX0DI0EHHHILE0J00LE0JKKL'; -- expert challenge 197  
  v_str := '0ACC0E0AD00EXXDII00B00000BHHHFGGG00F';
  v_str := 'AAB00HC0BGGHC0XXJIDD0LJIEEELK0FFFLK0';
--  v_str := 'BBBCDEAA0CDEXX0F00GIIFLLG0JKKMHHJ00M';
--  v_str := 'A00DDDA00F0EAXXF0EBBBG0E00CG0000CHH0';
--  v_str := '00AGGB00AH0BXXAH0BDCCC00DEEI00FF0I00';
    v_str := '0HH00BEE0C0BXXFC0B00F0000000DAGG00DA'; -- no solution
